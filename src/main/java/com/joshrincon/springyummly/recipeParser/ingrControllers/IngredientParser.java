package com.joshrincon.springyummly.recipeParser.ingrControllers;

import com.joshrincon.springyummly.recipeParser.dictionary.DictionaryManager;
import com.joshrincon.springyummly.recipeParser.dictionary.StemmerX;
import com.joshrincon.springyummly.recipeParser.dictionary.VocabType;
import com.joshrincon.springyummly.recipeParser.dictionary.Vocabulary;
	...
	public Ingredient parseIngredient(String line, int lineIndex){
		...
		if(measurements != null)  {
			...
			for(String[] meas : measurements) {
				...
				line=line.replace("" + meas[this.AMOUNT_IDX] + "" + meas[this.UNIT_IDX], "");
			}
		}
